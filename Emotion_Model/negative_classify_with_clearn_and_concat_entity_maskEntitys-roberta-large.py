...
####################################################################
maxlen = 509
bert_path = '../../PreTrainModel/roeberta_zh_L-24_H-1024_A-16/'     # chinese_L-12_H-768_A-12    chinese_wwm_ext_L-12_H-768_A-12
...
np.save('weights/train_bert_negtive_prob_roberta-large.npy', train_model_pred)
np.save('weights/test_bert_negtive_prob_roberta-large.npy', test_model_pred)
...
test_index.to_csv('./submit/emotion_res_1.csv', encoding='utf-8', index=None)
print('store over')