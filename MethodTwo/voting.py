...
data = pd.read_csv('./single/five_models_voting_three_method.csv', encoding='utf-8').rename(columns={'negative': 'negative_1', 'key_entity': 'key_entity_1'})
...
print(submit)
submit[['id', 'negative', 'key_entity']].to_csv('five_res_all_voting.csv', encoding='utf-8',  index=None)
print('thresh:', thresh)
print('store done.')
