...
data = pd.read_csv('./single/entity_bert_base.csv', encoding='utf-8').rename(columns={'negative': 'negative_1', 'key_entity': 'key_entity_1'})
...
print(submit)
submit[['id', 'negative', 'key_entity']].to_csv('three_model_voting_lj.csv', index=None)
print('store done.')
