...
#######################################################
maxlen = 509
bert_path = '../../PreTrainModel/chinese_wwm_ext_L-12_H-768_A-12/'     # chinese_L-12_H-768_A-12    chinese_wwm_ext_L-12_H-768_A-12   chinese_roberta_wwm_ext_L-12_H-768_A-12
...
np.save('weights/bert_prob_train_binary_label_add_feature_extend_trainSet-PreProcess-bert_wwm.npy', train_model_pred)
np.save('weights/bert_prob_test_binary_label_add_feature_extend_trainSet-PreProcess-bert_wwm.npy', test_model_pred)
...
submit.to_csv('./submit/entity_bert_wwm.csv', encoding='utf-8', index=None)