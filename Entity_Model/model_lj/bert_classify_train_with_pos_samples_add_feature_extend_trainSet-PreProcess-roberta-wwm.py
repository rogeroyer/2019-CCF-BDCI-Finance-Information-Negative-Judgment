...
#######################################################
maxlen = 509
bert_path = '../../PreTrainModel/chinese_roberta_wwm_ext_L-12_H-768_A-12/'     # chinese_L-12_H-768_A-12    chinese_wwm_ext_L-12_H-768_A-12   chinese_roberta_wwm_ext_L-12_H-768_A-12
...
class data_generator:
    def __init__(self, data, feature, batch_size=4, shuffle=True):    # 8
        self.data = data
...
train_model_pred, test_model_pred = run_cv(5, DATA_LIST, train_feature, None, DATA_LIST_TEST, test_feature)
print('validate aver f1 score:', np.average(f1))
print('validate aver accuracy score:', np.average(acc))
np.save('weights/bert_prob_train_binary_label_add_feature_extend_trainSet-PreProcess-roberta_wwm.npy', train_model_pred)
np.save('weights/bert_prob_test_binary_label_add_feature_extend_trainSet-PreProcess-roberta_wwm.npy', test_model_pred)
...
submit.to_csv('./submit/entity_roberta_wwm.csv', encoding='utf-8', index=None)