...
bert_path ='../../PreTrainModel/chinese_roberta_wwm_ext_L-12_H-768_A-12/'    #模型地址
...
save_mdoel_name_pre='robertawmmext'
#################################################load data#########################################
...
sub.to_csv('result/robertawmmext_result_mean.csv',index=False)
