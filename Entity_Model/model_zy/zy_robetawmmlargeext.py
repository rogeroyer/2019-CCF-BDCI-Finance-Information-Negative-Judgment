...
bert_path ='../../PreTrainModel/chinese_roberta_wwm_large_ext_L-24_H-1024_A-16/'    #模型地址
...
save_mdoel_name_pre='robertawmm_large'
#################################################load data#########################################
...
sub.to_csv('result/robertawmmlarge_result_mean.csv',index=False)
